    ...
    useEffect(() => {
        const checkSabbath = () => {
           // const now = new Date(); NOT USED
            ...
            //check if the current time is 8pm Friday (this is when orders are no longer being received)
            if(day === 5 && hour >= 20){
                setNoMoreOrders(true);
            }else{
                setNoMoreOrder(false);
            }
        };
    ...
    return(
        <div id="mainContent">
            ...
            <div className='sideBar'>
                ...
                <h3>pre-orders end: <i>Friday @8pm CST!</i></h3>
            </div>
            {/*START OF FORM*/}
            <form id='userForm' onSubmit={handleSubmit}>
                ...
                */}
                ...
                <br/>
                {/*Meals*/}
                <h2>PLEASE SELECT YOUR COFFEE CHOICES BELOW</h2>
                {/*
